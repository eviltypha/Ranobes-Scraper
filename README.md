...
<table>
    <tr>
        <td><img src = "images/Lithium/lithium_1.png" height = 10% width = 110% alt = "lithium_1"></td>
        <td><img src = "images/Lithium/lithium_2.png" height = 10% width = 110% alt = "lithium_2"></td>
    </tr>
    <tr>
